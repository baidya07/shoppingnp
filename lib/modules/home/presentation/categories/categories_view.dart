...
import 'package:shoppingnp/modules/home/data/models/homeData/home_data.dart';
...
class ShopCategoryView extends ConsumerWidget {
  ...
  Widget build(BuildContext context,  WidgetRef ref) {
    ...
    final model = ref.watch(categoryListChangeNotifierProvider);
    return model.apiResult.when(data: (data) {
